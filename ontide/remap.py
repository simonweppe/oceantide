...
"""Remap tools - a fast interpolator using scrip: https://github.com/SCRIP-Project/SCRIP."""
...
def make_remap_grid_file(Cgrd, Cpos='t'):
    ...
    nc.Description = 'remap grid file for OTIS'
    nc.Author = 'ontide.remap.make_remap_grid_file'
    nc.Created = dt.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    nc.title = Cgrd.name
